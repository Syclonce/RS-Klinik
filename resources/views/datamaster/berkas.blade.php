                    ...
                    <div class="mt-3 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="mb-0 card-title">Kelola Berkas Digital</h3>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addModalLabel">Kelola Berkas Digital</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="addFormpermesion" action="{{ route('datmas.berkas.add') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="kode" name="kode" placeholder="Generate Kode Berkas Digital" readonly>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#generateKodeButton').click(function() {
                ...
                $.ajax({
                    url: '/generate-kode-berkas', // Route untuk generate kode
                    type: 'GET',
