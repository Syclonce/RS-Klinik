                    ...
                    <div class="mt-3 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="mb-0 card-title">Kelola Jenis Perawatan Rawat Jalan</h3>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addModalLabel">Kelola Jenis Perawatan Jalan</h5>
                    ...
                    <form id="addFormpermesion" action="{{ route('datmas.perjal.add') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Nama </label>
                                    <input type="text" class="form-control" id="nama_perjal" name="nama_perjal">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#generateKodeButton').click(function() {
                ...
                $.ajax({
                    url: '/generate-kode-perjal', // Route untuk generate kode
                    type: 'GET',
