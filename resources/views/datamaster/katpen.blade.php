                    ...
                    <div class="mt-3 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="mb-0 card-title">Kelola Data Kategori Penyakit</h3>
                            ...
                            <div class="card-body">
                              <table id="janjitbl" class="table table-bordered table-striped">
                                ...
                                <tr>
                                  ...
                                  <th class="text-center">Ciri Umum</th>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addModalLabel">Kelola Data Kategori Penyakit</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="addFormpermesion" action="{{ route('datmas.katpen.add') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label>Ciri Umum</label>
                                    <input type="text" class="form-control" id="ciri" name="ciri">
                                </div>
                            </div>
                        </div>
                </div>
