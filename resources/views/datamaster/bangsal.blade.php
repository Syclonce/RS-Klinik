                    ...
                    <div class="mt-3 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="mb-0 card-title">Kelola Data Bangsal</h3>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addFormpermesion" action="{{ route('datmas.bangsal.add') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label>Kode Bangsal </label>
                                    <input type="text" class="form-control" id="kode_bangsal" name="kode_bangsal">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label>Nama Bangsal</label>
                                    <input type="text" class="form-control" id="nama_bangsal" name="nama_bangsal">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
