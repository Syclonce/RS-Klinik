                              ...
                              <table id="janjitbl" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @foreach ($data as $data)
                                            <tr>
                                                <td>{{ $data->kode_rawatan }}</td>
                                                <td>{{ $data->nama_rawatan }}</td>
                                                <td></td>
                                            </tr>
                                    @endforeach
                                </tbody>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="kode_rawatan" name="kode_rawatan">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label>Nama Kategori Rawatan</label>
                                    <input type="text" class="form-control" id="nama_rawatan" name="nama_rawatan">
                                </div>
                            </div>
                        </div>
                </div>
