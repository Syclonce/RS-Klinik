                    ...
                    <div class="mt-3 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="mb-0 card-title">Akuntan</h3>
                            ...
                            <div class="card-body">
                                <table id="doctortbl" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        @foreach ($akuntan as $akuntan)
                                            <tr>
                                                <td>{{ $akuntan->nama }}</td>
                                                <td>{{ $akuntan->Alamat }}</td>
                                                <td>{{ $akuntan->telepon }}</td>
                                                <td>{{ $akuntan->user->email }}</td>
                                                <td>
                                                </td>
                                            </tr>
                                        @endforeach
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('sdm.akuntan.add') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-sm-6">
