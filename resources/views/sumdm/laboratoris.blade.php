                    ...
                    <div class="mt-3 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="mb-0 card-title">Labolatoris</h3>
                            ...
                            <div class="card-body">
                                <table id="doctortbl" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        @foreach ($labotori as $labotori)
                                            <tr>
                                                <td>{{ $labotori->nama }}</td>
                                                <td>{{ $labotori->Alamat }}</td>
                                                <td>{{ $labotori->telepon }}</td>
                                                <td>{{ $labotori->user->email }}</td>
                                                <td>
                                                </td>
                                            </tr>
                                        @endforeach
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('sdm.laboratorium.add') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-sm-6">
