                ...
                <div class="mt-3 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="mb-0 card-title">Refrensi ICD 9</h3>
                        ...
                        <div class="card-body" id="kunjungan-section">
                            <table id="tabelkodedata" class="table table-bordered table-striped">
                                <thead>
                                    <tr>                                        
                                        <th class="text-center" width="40%">Kode ICD 9</th>
                                        <th class="text-center" width="40%">Nama ICD 9</th>                                       
                                        <th class="text-center" width="20%">Harga ICD 9</th>                                       
                                    </tr>
                                </thead>
                                <tbody >
