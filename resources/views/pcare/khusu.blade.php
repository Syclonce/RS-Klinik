                ...
                <div class="mt-3 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="mb-0 card-title">Refrensi Khusus</h3>
                          ...
                          <div class="card-body" id="kunjungan-section">
                            <table id="tabelkodedatabpjs" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th class="text-center" width="50%">Kode Khusus</th>
                                        <th class="text-center" width="50%">Nama Khusus</th>                                        
                                    </tr>
                                </thead>
                                <tbody >
