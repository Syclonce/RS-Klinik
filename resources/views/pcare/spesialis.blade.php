                ...
                <div class="mt-3 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="mb-0 card-title">Refrensi Spesialis</h3>
                          ...
                          <div class="card-body" id="kunjungan-section">
                            <table id="tabelkodedatabpjs" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th class="text-center" width="30%">Kode Spesialis</th>
                                        <th class="text-center" width="40%">Nama Spesialis</th>
                                        <th class="text-center" width="30%">Sub Data Spesialis</th>
                                    </tr>
                                </thead>
                                <tbody >
                                    @foreach ($spesialis as $data)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ route('pcare.subspesialis', ['kode' => $data->kode]) }}" class="btn btn-primary"><i class="fa-solid fa-briefcase-medical"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                </tbody>
